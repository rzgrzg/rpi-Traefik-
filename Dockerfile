...
ADD https://github.com/containous/traefik/releases/download/v$Traefik_VERSION/traefik_v$Traefik_VERSION_linux_armv7.tar.gz /var/traefik/traefik_v$Traefik_VERSION_linux_armv7.tar.gz
